...
import { Container, Row, Col, Card, Table, Image, Pagination, Spinner, Alert } from "react-bootstrap";
...
const UsersListPage = () => {
  ...
  const { data, isLoading, isError, error, refetch, isFetching } = useGetAllUsersQuery({
    page,
    size: PAGE_SIZE,
  });
        ...
        <Card.Body>
          {isLoading ? (
            ...
            <>
              ...
              {!isCurrentUserAdmin && (
                <div className="mt-3" style={{ fontSize: 13, opacity: 0.75 }}>
